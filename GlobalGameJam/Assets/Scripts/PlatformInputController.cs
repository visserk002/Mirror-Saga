...
public class PlatformInputController : MonoBehaviour
{
	...
	public string inputStringMovement, inputStringJump;
    ...
    void Update()
    {
		...
		Vector3 directionVector = new Vector3(Input.GetAxis(inputStringMovement), Input.GetAxis("Vertical"), 0);
		...
		motor.inputJump = Input.GetButton(inputStringJump);
